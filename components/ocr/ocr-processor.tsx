...
export function OcrProcessor({
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="relative mx-auto max-w-[280px] overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm">
        {documentPreview ? (
      ...
      <div className="text-center">
        ...
        <p className="mt-1 text-2xl font-semibold tabular-nums text-indigo-500">
          {progress}%
        </p>
