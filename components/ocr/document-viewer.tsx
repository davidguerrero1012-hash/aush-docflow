  ...
  return (
    <div className="space-y-2">
      ...
      <div
        ...
        className="relative overflow-hidden rounded-lg border border-zinc-200 bg-zinc-50 focus-visible:ring-2 focus-visible:ring-indigo-500/20 focus-visible:outline-none cursor-grab active:cursor-grabbing"
