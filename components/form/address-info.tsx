      ...
      <div className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              >
                <SelectTrigger
                  ...
                  className={`h-11 w-full rounded-lg border-zinc-200 text-[15px] focus-visible:ring-2 focus-visible:ring-indigo-500/20 focus-visible:border-indigo-500 ${
        ...
        >
          <label className="flex items-center gap-3 cursor-pointer select-none">
            <input
              type="checkbox"
              className="h-5 w-5 rounded border-zinc-300 text-indigo-500 focus:ring-2 focus:ring-indigo-500/20 accent-indigo-500"
        ...
        <AnimatePresence mode="wait">
          {!mailingSame && (
            ...
            >
              <div className="space-y-5 rounded-xl border border-zinc-200 bg-zinc-50/50 p-5">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    ...
                    className="h-11 rounded-lg border-zinc-200 bg-white text-[15px] placeholder:text-zinc-400 focus-visible:ring-2 focus-visible:ring-indigo-500/20 focus-visible:border-indigo-500"
                ...
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <SelectTrigger
                        id="mailingState"
                        className="h-11 w-full rounded-lg border-zinc-200 bg-white text-[15px] focus-visible:ring-2 focus-visible:ring-indigo-500/20 focus-visible:border-indigo-500"
                      >
                        <SelectValue placeholder="State" />
                      </SelectTrigger>
                      <SelectContent>
