        ...
        >
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              className={`rounded-lg border-zinc-200 text-[15px] placeholder:text-zinc-400 focus-visible:ring-2 focus-visible:ring-indigo-500/20 focus-visible:border-indigo-500 ${
